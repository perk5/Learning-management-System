...
const CourseDetails = () => {
  ...
  const {allCourses, calculateRating, 
    calculateChapterTime, calculateNoOfLectures, CalculateCourseDuration, currency} = useContext(AppContext)
    ...
    <>
      ...
      justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p
          className='pt-4 md:text-base txt-sm' 
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>SuperSimpleDev</span></p>
        ...
        <div className='max-w-course-card z-10 shadow-custom-card rounded-lg overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5'>
            ...
            <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
                ...
                <div className='flex items-center gap-1'>
                  <img src={assets.time_clock_icon} alt="star_clock_icon" />
            ...
            hover:bg-blue-700 transition-colors text-white font-medium'>{isAlreadyEnrolled ? 'Already Enrolled' : 
            'Enroll Now'}</button>
            <div className='pt-6'>
